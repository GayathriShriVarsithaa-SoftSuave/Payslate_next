    ...
    return(<section id="home">
        ...
        <div className="h-[884px] bg-[white]">
            <div className="mt-[4px]">
                <p className="text-[#932EFA] font-semibold text-[16px] leading-[150%] uppercase w-[1403px] mx-auto">Features</p>
            ...
            <div className="flex flex-row justify-between w-[1403px] mx-auto mt-[110px]">
                <motion.div className="bg-[#F1EFFF] h-[254px] w-[434px] rounded-[40px] " variants={leftcardVariants} initial="hidden" whileInView="visible" transition={{duration:0.6, delay:0.3,ease:"easeIn"}} viewport={{once:false}} >
                ...
                <motion.div className="bg-[#EFF2FF] h-[254px] w-[434px] rounded-[40px]"  initial={{x:420}} whileInView={{x:0}} transition={{duration:0.6, delay:0.3,ease:"easeIn"}} viewport={{once:false}}>
                    <div className="bg-[#804FB0] h-[68px] w-[68px] rounded-[20px] mt-[40px] ml-[40px]">
            ...
            <div className="flex flex-row justify-between w-[1403px] mx-auto mt-[110px]">
                <motion.div className="bg-[#EFF4FF] h-[254px] w-[434px] rounded-[40px] " variants={leftcardVariants} initial="hidden" whileInView="visible" transition={{duration:0.6, delay:0.3,ease:"easeIn"}} viewport={{once:false}}>
                    <div className="bg-[#804FB0] h-[68px] w-[68px] rounded-[20px] mt-[40px] ml-[40px]">
                ...
                <motion.div className="bg-[#FFEFFB] h-[254px] w-[434px] rounded-[40px]" initial={{x:420}} whileInView={{x:0}} transition={{duration:0.6, delay:0.3,ease:"easeIn"}} viewport={{once:false}}>
                    <div className="bg-[#804FB0] h-[68px] w-[68px] rounded-[20px] mt-[40px] ml-[40px]">
