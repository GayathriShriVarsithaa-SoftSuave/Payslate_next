...
export default function DownloadApp(){
    ...
    function screenSize(){
        if(widthscreen<=640) return("sm");
        else if(widthscreen<=768) return("md");
        else if(widthscreen<=1024) return("lg");
        else if(widthscreen<=1280) return("xl");
        return("2xl");
    }
    ...
    return(
        <section id="downloadapp">
            <div className="mx-auto flex flex-col w-[1395px]">
                <p className="text-violettxt font-semibold leading-[150%] text-[16px] uppercase">Download App</p>
            ...
            <div className="flex flex-row justify-around w-[1395px] mx-auto mt-[80px] ">
                <motion.div className="bg-[#F7F8FD] h-[775px] w-[654px] rounded-[16px] overflow-hidden" initial="rest" whileHover="hover">
                    ...
                    <Button onClick={()=>window.open("https://apps.apple.com/in/app/payslate/id6737227735")} sx={{marginLeft:"48px",backgroundColor:"var(--buttonbg)",borderRadius:"30px",color:"white",marginTop:"16px"}}>App store</Button>
                    <motion.img src="/iOS.png" className="mx-auto mt-[275px] hidden sm:flex" variants={{rest:{y:200},hover:{y:0}}} transition={{duration:0.3}}/>
                </motion.div>
                ...
                <motion.div className="bg-[#FEFCF9] h-[775px] w-[654px] rounded-[16px] overflow-hidden" initial="rest" whileHover="hover">
                    ...
                    <Button onClick={()=>window.open("https://play.google.com/store/apps/details?id=com.dotmite.payslate")} sx={{marginLeft:"48px",backgroundColor:"var(--buttonbg)",borderRadius:"30px",color:"white",marginTop:"16px"}}>Play store</Button>
                    <motion.img src="/android.png" className="mx-auto mt-[275px] hidden sm:flex" variants={{rest:{y:200},hover:{y:0}}} transition={{ duration:0.3}}/>
                </motion.div>
            </div>
        </section>
    );
